#!/usr/bin/env python3
"""
Simple test for HEX to BIN conversion
"""
...
def test_simple_hex():
    """Test with a minimal valid HEX file"""
    print("Testing simple HEX conversion...")
    ...
    # Create test HEX file with minimal valid format
    test_dir = tempfile.mkdtemp(prefix="test_hex_")
    hex_file = os.path.join(test_dir, "test.hex")
    
    # Create a minimal valid HEX file (just 16 bytes of data)
